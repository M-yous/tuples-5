# Impot required modules/packages/library
from pprint import pprint
from collections import namedtuple

# Creat named tuple to store information
...
for line in file:
    # Add gevice info into a named tuple
    ...
    if device_info.os_type not in os_types: os_types.add(device_info.os_type)
